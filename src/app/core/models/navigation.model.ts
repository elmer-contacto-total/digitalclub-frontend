  ...
  super_admin: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'bulk-sends', label: 'Envíos Masivos', icon: 'ph-broadcast', route: '/app/bulk_sends' }
      ]
    },
    {
      id: 'reports',
  ...
  admin: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'bulk-sends-electron', label: 'Envíos Masivos', icon: 'ph-paper-plane-tilt', route: '/app/bulk_sends' }
      ]
    },
    {
      id: 'settings',
