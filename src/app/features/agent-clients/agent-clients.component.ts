        ...
        <div class="table-container">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover">
              <thead>
                <tr>
                  <th class="col-nombre" [appSort]="'fullName'" [appSortState]="sort()" (appSortChange)="onSort($event)">Nombre</th>
...
export class AgentClientsComponent implements OnInit, OnDestroy {
  ...
  sortedClients = computed(() => sortRows(this.clients(), this.sort(), (c: UserListItem, col: string) => {
    switch (col) {
      case 'fullName': return c.fullName || `${c.firstName || ''} ${c.lastName || ''}`.trim();
