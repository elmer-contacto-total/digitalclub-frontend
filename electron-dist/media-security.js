...
exports.setupDownloadBlocking = setupDownloadBlocking;
exports.injectSecurityScripts = injectSecurityScripts;
exports.setupMediaCapture = setupMediaCapture;
exports.generateMediaId = generateMediaId;
exports.initializeMediaSecurity = initializeMediaSecurity;
...
function setupDownloadBlocking(view, mainWindow, userId, onAuditLog) {
...
function injectSecurityScripts(view) {
...
function setupMediaCapture(view, userId, onMediaCaptured, onAuditLog) {
    let pollingInterval = null;
    async function collectCapturedMedia() {
        try {
...
function initializeMediaSecurity(view, mainWindow, userId, callbacks) {
